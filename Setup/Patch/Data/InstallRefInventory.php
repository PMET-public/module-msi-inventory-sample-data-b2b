...
namespace MagentoEse\MsiInventorySampleDataB2B\Setup\Patch\Data;
...
class InstallRefInventory implements DataPatchInterface
{
    ...
    {
        $this->sampleData->addInventory(['MagentoEse_MsiInventorySampleDataB2B::fixtures/b2b_msi_inventory.csv']);
